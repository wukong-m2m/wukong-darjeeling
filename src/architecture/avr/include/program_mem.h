...
#define dj_di_getU8(pointer)  (pgm_read_byte_near(pointer))
#define dj_di_getU16(pointer) (pgm_read_word_near(pointer))
#define dj_di_getU32(pointer) (pgm_read_dword_near(pointer))
#define dj_di_getLocalId(pointer) ((dj_local_id){pgm_read_byte_near(pointer),pgm_read_byte_near(pointer+1)})
