...
type ResultAvr = { unopt : AvrInstruction;
                           opt : AvrInstruction option;
                           counters : ExecCounters }
type ResultJava = { jvm : JavaInstruction;
                    avr : ResultAvr list;
                    counters : ExecCounters }
type Results = {
...
let rec addCycles (jvmInstructions : JavaInstruction list) (profilerdata : ProfiledInstruction list) (matchedResults : (AvrInstruction option*AvrInstruction*JavaInstruction) list) =
