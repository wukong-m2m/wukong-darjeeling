    ...
    let resultsToString (results : SimulationResults) =
        ...
        let countersToStringInclSubroutines totalCycles totalBytes (counters : ExecCounters) =
            ...
            String.Format("{0,11:n0} {1,5:0.0}% {2,9:n0} {3,9:0.0} | {4,5} {5,5:0.0}%",
                          ...
                          counters.executions,
                          counters.averageInclSubroutine,
                          counters.size,
        ...
        addLn (String.Format ("              C   ratio                  {0,14}", (cyclesToSlowdown results.cyclesStopwatchC results.countersCTotalPlusTimer.cycles)))
        addLn ("")
        ...
        addLn (String.Format ("              AOT ratio                  {0,14}", (cyclesToSlowdown results.cyclesStopwatchAOT results.countersAOTTotalPlusTimer.cycles)))
        addLn ("")
