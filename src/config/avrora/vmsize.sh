...
gdj vm_size -Paotbm=md5 -Pno-rtc-guards -Paotstrat=markloop         -Puseconstantshiftoptimisation=true  -Puse16bitarrayindex=true  -Pusesimul=true  -Puselightweightmethods=true  -Psafe >> vmsize_4MARK_R11_P7_C1_A1_S1_G1_SAFE.txt
...
echo -n "vmsize_4MARK_R11_P7_C1_A1_S1_G1_SAFE    " >> vmsize.txt
grep "AOT compiler" vmsize_4MARK_R11_P7_C1_A1_S1_G1_SAFE.txt | head -n 1 >> vmsize.txt
