...
#define DJ_PANIC_ILLEGAL_INTERNAL_STATE_NOT_A_HEAP_PTR    RUNLEVEL_PANIC+22
#define DJ_PANIC_NO_ADDRESS_FOUND_FOR_LIGHTWEIGHT_METHOD  RUNLEVEL_PANIC+23
#define DJ_PANIC_LIGHTWEIGHT_METHOD_MUST_BE_LOCAL         RUNLEVEL_PANIC+24
#define DJ_PANIC_UNSAFE_CODE_REJECTED                     RUNLEVEL_PANIC+25
#define DJ_PANIC_AOT_ASM_ERROR                            RUNLEVEL_PANIC+50
#define DJ_PANIC_AOT_ASM_ERROR_OFFSET_OUT_OF_RANGE        RUNLEVEL_PANIC+51
