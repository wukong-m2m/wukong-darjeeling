...
public class BCELInstructionAdapter
{
	...
	static
	{
		...
		opcodeMap.put(Constants.BALOAD, Opcode.GETARRAY_B);
		opcodeMap.put(Constants.CALOAD, Opcode.GETARRAY_C);
		opcodeMap.put(Constants.SALOAD, Opcode.GETARRAY_S);
		opcodeMap.put(Constants.IALOAD, Opcode.GETARRAY_I);
		opcodeMap.put(Constants.LALOAD, Opcode.GETARRAY_L);
		opcodeMap.put(Constants.AALOAD, Opcode.GETARRAY_A);
		opcodeMap.put(Constants.BASTORE, Opcode.PUTARRAY_B);
		opcodeMap.put(Constants.CASTORE, Opcode.PUTARRAY_C);
		opcodeMap.put(Constants.SASTORE, Opcode.PUTARRAY_S);
		opcodeMap.put(Constants.IASTORE, Opcode.PUTARRAY_I);
		opcodeMap.put(Constants.LASTORE, Opcode.PUTARRAY_L);
		opcodeMap.put(Constants.AASTORE, Opcode.PUTARRAY_A);
