...
public class CoreListJoinA {
	...
	*/
		...
		public static int cmp_complex(ListData a, ListData b, CoreResults res) {
	...
	/* Function: cmp_idx
		...
		Can be used by mergesort.
	*/
		public static int cmp_idx(ListData a, ListData b, CoreResults res) {
			if (res==null) {
	        ...
	        while (p!=null) {
	            ...
	            while (psize > 0 || (qsize > 0 && q!=null)) {
					...
					if (psize == 0) {
					    ...
					    e = p; p = p.next; psize--;
					} else if ((useIdxCompare ? cmp_idx(p.info,q.info,res) : cmp_complex(p.info,q.info,res)) <= 0) {
