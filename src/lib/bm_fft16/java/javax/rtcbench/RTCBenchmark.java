...
public class RTCBenchmark {
    public static String name = "FIX_FFT 16";
    ...
    // The optimised version works with the massive const array shown below, 
    // but the baseline won't compile because the clinit method becomes too
    // large for memory.
    // Initialise it in native C instead.
    private final static short Sinewave[] = new short[1024];
    private static native void initSinewave(short Sinewave[]);
