...
public class RTCBenchmark {
    public static String name = "FIX_FFT 16 NOPT";
        ...
        while(l < n) {
            ...
            for(m=0; m<l; ++m) {
                ...
                for(i=m; i<n; i+=istep) {
                    ...
                    tr =  (short)(   ((short) ((wr*fr[j])>>15)) - ((short) ((wi*fi[j])>>15))      );
                    ti =  (short)(   ((short) ((wr*fi[j])>>15)) + ((short) ((wi*fr[j])>>15))      );
