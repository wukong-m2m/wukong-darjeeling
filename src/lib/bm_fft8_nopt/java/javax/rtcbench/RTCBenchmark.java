...
public class RTCBenchmark {
    public static String name = "FIX_FFT 8 NOPT";
    ...
    public static short rtcbenchmark_measure_java_performance(byte[] fr, byte[] fi, short m, boolean inverse) {
        ...
        while (l < n) {
            ...
            for (m=0; m<l; ++m) {
                ...
                short sin_n = (short)((short)(j + N_WAVE/4) & 0xFF);
                wr =  Sinewave.data[sin_n]; // COS8(j)
                sin_n = (short)(j & 0xFF);
                wi = (byte)-Sinewave.data[sin_n]; // -SIN8(j)
                if (inverse)
                    wi = (byte)-wi;
                if (shift) {
                    wr >>= 1;
                ...
                for (i=m; i<n; i+=istep) {
                    ...
                    short b,c;
                    c = (short)((short)((short)wr * (short)fr[j]) >> 6);
                    b = (byte)(c & 0x01);
                    short FIX_MPY_wr_frj = (byte)((c >> 1) + b);
                    c = (short)((short)((short)wi * (short)fi[j]) >> 6);
                    b = (byte)(c & 0x01);
                    short FIX_MPY_wi_fij = (byte)((c >> 1) + b);
                    c = (short)((short)((short)wr * (short)fi[j]) >> 6);
                    b = (byte)(c & 0x01);
                    short FIX_MPY_wr_fij = (byte)((c >> 1) + b);
                    c = (short)((short)((short)wi * (short)fr[j]) >> 6);
                    b = (byte)(c & 0x01);
                    short FIX_MPY_wi_frj = (byte)((c >> 1) + b);

                    tr = (byte)(FIX_MPY_wr_frj - FIX_MPY_wi_fij);
                    ti = (byte)(FIX_MPY_wr_fij + FIX_MPY_wi_frj);
