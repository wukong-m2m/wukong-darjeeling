...
public class RTCTestFixFFT {
	// public static native void test_fixfft_native();
	
	// public static void test_fixfft() {
	...
	// 	do_fixfft(data, im, (byte)RTCTEST_FFT_ARRAYSIZE, false);
