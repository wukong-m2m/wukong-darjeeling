...
#define INFUSION_FORMAT_VERSION 114
#else
 // Version 101: 16 bit index
#define INFUSION_FORMAT_VERSION 115
#endif
...
#define dj_di_methodImplementation_getNumberOfVariableSlots(pointer) dj_di_getU8(pointer + 11)
