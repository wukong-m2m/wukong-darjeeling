...
#define dj_di_methodImplementation_getMaxRefStack(pointer) dj_di_getU8(pointer + 7)
#define dj_di_methodImplementation_getFlags(pointer) dj_di_getU8(pointer + 8)
#define dj_di_methodImplementation_getReturnType(pointer) dj_di_getU8(pointer + 9)
#define dj_di_methodImplementation_getNumberOfBranchTargets(pointer) dj_di_getU16(pointer + 10)
#define dj_di_methodImplementation_getNumberOfOwnVariableSlots(pointer) dj_di_getU8(pointer + 12)
#define dj_di_methodImplementation_getNumberOfTotalVariableSlots(pointer) dj_di_getU8(pointer + 13)
#define dj_di_methodImplementation_getLength(pointer) dj_di_getU16(pointer + 14)
#define dj_di_methodImplementation_getData(pointer) (pointer + 16)
