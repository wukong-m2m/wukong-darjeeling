...
Block.prototype.attach=function(parent) {
	...
	this.div.dblclick(function() {
		...
		$('#propertyeditor_tab').append('<ul><li><a href=#propertyeditor_loc>Location Policy</a></li><li style=""><a href=#propertyeditor_ft>Policy</a></li><li><a href=#propertyeditor_default>Default Value</a></li><li style="display:none"><a href=#propertyeditor_monitor>Monitors</a></li></ul>');
		...
		$('#propertyeditor_tab').append('<div id=propertyeditor_ft><label for="propertyeditor_groupsize">Group Size(-1 means match all instances)</label><br><input id=propertyeditor_groupsize name=value></input></div>');
