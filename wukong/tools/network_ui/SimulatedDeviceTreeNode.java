...
public class SimulatedDeviceTreeNode extends DeviceTreeNode implements DirectoryWatcherListener {
	...
	public SimulatedDeviceTreeNode(String network_directory, String node_directory, DirectoryWatcher directorywatcher, DefaultTreeModel treemodel) throws java.io.IOException {
